'Los textos que están con el apóstrofe son comentarios

'LEAN con atención los comentarios.

'Se requiere importar la libreria para la comunicación con Oracle
...
Public Class Oracle
    ...
    Public Sub New()
        ...
        '          User Id=fraccionamiento Es el nombre del usuario creado por system es el dueño de las tablas
        '          Password=fraccionamiento Es la contraseña del usuario

        cnx = New OracleConnection("Data Source = XE; User Id = fraccionamiento; Password = fraccionamiento;")
